...
extern "C" SEXP _denclim_dust_model_gpu_info() {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_alloc(SEXP r_pars, SEXP pars_multi, SEXP r_time, SEXP r_n_particles, SEXP n_threads, SEXP r_seed, SEXP deterministic, SEXP gpu_config, SEXP ode_control) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_capabilities() {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_run(SEXP ptr, SEXP r_time_end) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_simulate(SEXP ptr, SEXP time_end) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_run_adjoint(SEXP ptr) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_set_index(SEXP ptr, SEXP r_index) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_update_state(SEXP ptr, SEXP r_pars, SEXP r_state, SEXP r_time, SEXP r_set_initial_state, SEXP index, SEXP reset_step_size) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_state(SEXP ptr, SEXP r_index) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_time(SEXP ptr) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_reorder(SEXP ptr, SEXP r_index) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_resample(SEXP ptr, SEXP r_weights) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_rng_state(SEXP ptr, SEXP first_only, SEXP last_only) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_set_rng_state(SEXP ptr, SEXP rng_state) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_set_data(SEXP ptr, SEXP data, SEXP shared) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_compare_data(SEXP ptr) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_filter(SEXP ptr, SEXP time_end, SEXP save_trajectories, SEXP time_snapshot, SEXP min_log_likelihood) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_set_n_threads(SEXP ptr, SEXP n_threads) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_n_state(SEXP ptr) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_set_stochastic_schedule(SEXP ptr, SEXP time) {
  BEGIN_CPP11
...
extern "C" SEXP _denclim_dust_cpu_model_ode_statistics(SEXP ptr) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_denclim_dust_cpu_model_alloc",                   (DL_FUNC) &_denclim_dust_cpu_model_alloc,                   9},
    {"_denclim_dust_cpu_model_capabilities",            (DL_FUNC) &_denclim_dust_cpu_model_capabilities,            0},
    {"_denclim_dust_cpu_model_compare_data",            (DL_FUNC) &_denclim_dust_cpu_model_compare_data,            1},
    {"_denclim_dust_cpu_model_filter",                  (DL_FUNC) &_denclim_dust_cpu_model_filter,                  5},
    {"_denclim_dust_cpu_model_n_state",                 (DL_FUNC) &_denclim_dust_cpu_model_n_state,                 1},
    {"_denclim_dust_cpu_model_ode_statistics",          (DL_FUNC) &_denclim_dust_cpu_model_ode_statistics,          1},
    {"_denclim_dust_cpu_model_reorder",                 (DL_FUNC) &_denclim_dust_cpu_model_reorder,                 2},
    {"_denclim_dust_cpu_model_resample",                (DL_FUNC) &_denclim_dust_cpu_model_resample,                2},
    {"_denclim_dust_cpu_model_rng_state",               (DL_FUNC) &_denclim_dust_cpu_model_rng_state,               3},
    {"_denclim_dust_cpu_model_run",                     (DL_FUNC) &_denclim_dust_cpu_model_run,                     2},
    {"_denclim_dust_cpu_model_run_adjoint",             (DL_FUNC) &_denclim_dust_cpu_model_run_adjoint,             1},
    {"_denclim_dust_cpu_model_set_data",                (DL_FUNC) &_denclim_dust_cpu_model_set_data,                3},
    {"_denclim_dust_cpu_model_set_index",               (DL_FUNC) &_denclim_dust_cpu_model_set_index,               2},
    {"_denclim_dust_cpu_model_set_n_threads",           (DL_FUNC) &_denclim_dust_cpu_model_set_n_threads,           2},
    {"_denclim_dust_cpu_model_set_rng_state",           (DL_FUNC) &_denclim_dust_cpu_model_set_rng_state,           2},
    {"_denclim_dust_cpu_model_set_stochastic_schedule", (DL_FUNC) &_denclim_dust_cpu_model_set_stochastic_schedule, 2},
    {"_denclim_dust_cpu_model_simulate",                (DL_FUNC) &_denclim_dust_cpu_model_simulate,                2},
    {"_denclim_dust_cpu_model_state",                   (DL_FUNC) &_denclim_dust_cpu_model_state,                   2},
    {"_denclim_dust_cpu_model_time",                    (DL_FUNC) &_denclim_dust_cpu_model_time,                    1},
    {"_denclim_dust_cpu_model_update_state",            (DL_FUNC) &_denclim_dust_cpu_model_update_state,            7},
    {"_denclim_dust_model_gpu_info",                    (DL_FUNC) &_denclim_dust_model_gpu_info,                    0},
    {NULL, NULL, 0}
};
}

extern "C" attribute_visible void R_init_denclim(DllInfo* dll){
